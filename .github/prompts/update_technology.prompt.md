...
- 以下のカテゴリに分類して技術スタックを整理すること
    - バックエンド（言語、フレームワーク、主要ライブラリ）
    - フロントエンド（言語、フレームワーク、主要ライブラリ）
    - 開発ツール（静的解析、ビルド、テスト、ドキュメンテーションツールなど）
    - インフラ・デプロイ（サーバー構成、CI/CD、コンテナ技術）
- 各技術要素について以下の情報を収集すること
    - 名称とメジャーバージョン
    - プロジェクト内での主な用途
    - 設定方法や重要なファイルの場所
- 各技術スタックは以下の分類で分けて記載すること
    - バックエンド
    - フロントエンド
    - CI/CD
...
- 実際の設定ファイルを修正・変更すること
- 推測に基づく情報を記載すること
- プロジェクトで使用されていない技術の追加を提案すること
- 過度に詳細な実装方法や機密情報を含めること
- 既存のドキュメントと矛盾する情報を記載すること
