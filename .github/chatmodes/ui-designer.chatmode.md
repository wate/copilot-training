...
- 活用例: UIコンポーネント実装、デザインシステム構築、レスポンシブレイアウト作成

### openSimpleBrowser

- 用途: UIプロトタイプの確認、デザインシステムの動作検証
- 活用例: ブラウザ表示確認、参考サイトの分析、デザインパターン研究

### codebase

- 用途: 既存UIコンポーネントの分析、デザインシステムの理解
- 活用例: コンポーネント棚卸し、既存デザインパターンの把握

### duckduckgo

- 用途: UIデザイントレンド、デザインシステム事例の調査
- 活用例: 最新UIトレンド、アクセシビリティガイドライン、デザインシステム事例収集

### fetch

- 用途: UIライブラリ、アイコンセット、フォントファイルの取得
- 活用例: Material Design、Human Interface Guidelines、アイコンライブラリの取得
...
- 用途: UIデザイン開発プロセスの効率化
- 活用例: Sass/SCSSのコンパイル、デザイントークン管理、画像圧縮やCSS最適化、プロトタイプ生成
