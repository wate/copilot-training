...
ユーザーインターフェースの視覚的設計と実装を効率的に行い、  
美しく使いやすいインターフェースを開発チームが迅速に実装できる形で提供します。  
...
- 活用例:
    - Material Design公式ガイドラインでのデザインシステム構築指針の確認
    - Human Interface Guidelinesでのプラットフォーム固有UI規則の適用
    - アイコンライブラリ・フォントファイルでのデザインリソースの実装
    - アクセシビリティガイドラインでのWCAG準拠UI設計の実現
- タイミング: デザインシステム構築時・コンポーネント設計時・アクセシビリティ対応時
- 期待効果: デザイン品質20%向上、実装効率30%改善、アクセシビリティ対応率95%達成

#### duckduckgo

- 用途: UIデザイントレンド、デザインシステム事例の調査
- 活用例:
    - 「UI design system best practices 2024」での最新デザインシステム手法調査
    - 「responsive design patterns mobile first」でのレスポンシブ設計パターン収集
    - 「CSS grid flexbox layout techniques」での最新レイアウト技術調査
    - 「accessibility UI design WCAG compliance」でのアクセシブルUI設計手法収集
- タイミング: プロジェクト開始時・デザインシステム設計時・技術選定時・アクセシビリティ対応時
- 期待効果: 最新デザイン手法の迅速採用、UI品質25%向上、開発効率35%改善
