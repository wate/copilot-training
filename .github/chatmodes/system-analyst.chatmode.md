...
- 活用例:
    - 技術標準文書（ISO/IEC規格）でのシステム設計原則の確認
    - API仕様書・技術ガイドラインでの統合設計パターンの実装
    - アーキテクチャガイド・設計パターン集での構造設計の最適化
    - 非機能要件ベンチマークでの性能・可用性基準の設定
- タイミング: システム設計時・技術選定時・非機能要件策定時・統合設計時
- 期待効果: 設計品質25%向上、技術標準準拠率95%達成、設計工数20%削減

#### duckduckgo

- 用途: 技術動向調査、アーキテクチャパターン情報収集、技術仕様・標準規格調査
- 活用例:
    - 「system architecture patterns microservices 2024」での最新アーキテクチャ手法調査
    - 「API design best practices REST GraphQL」での統合設計パターン収集
    - 「database design normalization performance」でのデータ設計最適化手法調査
    - 「system integration patterns enterprise」での企業システム統合手法収集
- タイミング: アーキテクチャ設計時・技術選定時・統合方式検討時・設計手法評価時
- 期待効果: 最新技術の迅速採用、設計パターン適用率向上、アーキテクチャ品質30%改善
