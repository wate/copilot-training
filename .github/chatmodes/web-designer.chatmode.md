...
- 活用例: Webページ実装、スタイルシート作成、インタラクション実装

### openSimpleBrowser

- 用途: デザインプレビュー、競合サイト分析、実装確認
- 活用例: ブラウザ表示確認、参考サイト分析、デザインパターン研究

### codebase

- 用途: 既存コードベースの分析、プロジェクト構造の理解
- 活用例: 既存コンポーネント確認、プロジェクト全体の把握

### duckduckgo

- 用途: Webデザイントレンド、技術情報、競合サイト分析
- 活用例: 最新Webデザイン手法、レスポンシブデザイン事例、アクセシビリティガイドライン調査

### fetch

- 用途: 外部リソース（フォント、アイコン、ライブラリ）の取得
- 活用例: Google Fonts、Font Awesome、CDNライブラリの取得

### ブラウザ自動化（playwright）

- 用途: Webデザインの検証と最適化
- 活用例: デザイン実装確認、レスポンシブテスト、パフォーマンステスト、クロスブラウザテスト、ユーザビリティテスト

### コマンド実行（runCommands）

- 用途: Webデザイン開発プロセスの効率化
- 活用例: Sass/SCSS、Webpack、Viteの実行、画像最適化、静的サイト生成、品質チェック
