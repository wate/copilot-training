...
- 活用例: `dbcode-executeQuery`でSQL実行、`dbcode-getTables`でスキーマ分析、`dbcode-getConnections`で接続管理
...
- 用途: データベース技術情報、パフォーマンスチューニング手法、エラー解決策の調査
- 活用例: 最新DBMS機能調査、チューニングベストプラクティス、エラーコード解決法
