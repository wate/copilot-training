...
データ駆動型プロダクト開発による市場適合性の実現
-------------------------

このチャットモードは、プロダクトリサーチャーが市場調査とユーザー調査を通じて、
製品開発に必要な戦略的インサイトを収集・分析し、データに基づく意思決定を支援します。
...
- 用途: 最新市場情報、競合動向、業界トレンド、学術研究のリアルタイム検索
- 活用例: 競合製品発表情報、市場規模統計、ユーザーレビュー分析、学術論文検索、業界専門家意見、技術トレンド調査
