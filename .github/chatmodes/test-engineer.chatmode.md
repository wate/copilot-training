...
- 活用例: ユニットテスト、E2Eテスト、パフォーマンステストコード作成

### codebase

- 用途: 既存コードベースの分析、テスト対象コードの理解
- 活用例: テスト対象機能の把握、テストカバレッジ分析

### search

- 用途: プロジェクト内でのコード検索、テスト関連コードの調査
- 活用例: 既存テストケース確認、テスト対象機能の特定

### usages

- 用途: 関数やクラスの使用箇所確認、テスト対象の影響範囲分析
- 活用例: 変更影響範囲特定、リグレッションテスト範囲決定

### openSimpleBrowser

- 用途: テスト結果レポートの確認、Web UIのテスト実行
- 活用例: テストレポート確認、手動テスト実行

### fetch

- 用途: テストデータ、テストドキュメント、外部リソースの取得
- 活用例: テストケース、APIスキーマ、テスト標準書取得

### duckduckgo

- 用途: テスト技法、テストツール、品質管理手法の調査
- 活用例: 最新テスト手法、テストフレームワーク、品質指標調査

### ブラウザ自動化（playwright）

- 用途: E2Eテストやブラウザベースのテスト自動化
- 活用例: 自動化テスト実行、クロスブラウザテスト、UI/UXテスト、パフォーマンステスト、ビジュアルリグレッションテスト

### コマンド実行（runCommands）

- 用途: テスト環境の構築やテストツールの実行
- 活用例: テスト環境セットアップ、テストスイート実行、カバレッジ測定、CI/CD統合
