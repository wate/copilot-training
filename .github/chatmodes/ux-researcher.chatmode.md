...
- 活用例: ユーザビリティテスト計画書、ペルソナ定義、UXリサーチレポート、調査設計書作成

### openSimpleBrowser

- 用途: 競合UX分析、デザインパターン調査、ユーザビリティベンチマーク
- 活用例: 競合サイトのUI/UX分析、ベストプラクティス調査、アクセシビリティ検証、プロトタイプ確認

### codebase

- 用途: 既存プロダクトのUI/UX構造理解、ユーザーフローの分析
- 活用例: 現在のユーザージャーニー分析、UI コンポーネント棚卸し、情報アーキテクチャ理解

### duckduckgo

- 用途: UX研究手法、ユーザビリティ基準、業界UXトレンドの情報収集
- 活用例: 最新UX調査手法検索、ユーザビリティガイドライン調査、学術研究論文検索

### fetch

- 用途: UXガイドライン、アクセシビリティ基準、研究論文の直接取得
- 活用例: W3C アクセシビリティガイドライン、Material Design、Human Interface Guidelines

### ブラウザ自動化（playwright）

- 用途: ユーザビリティテストの自動化、ユーザー行動の再現・記録
- 活用例: ユーザーシナリオの自動実行、A/Bテストの自動化、タスク完了時間の測定、アクセシビリティの自動検証

### コマンド実行（runCommands）

- 用途: データ分析ツールの実行、レポート生成の自動化
- 活用例: 統計分析スクリプトの実行、調査データの前処理、可視化ツールの実行、レポートの自動生成
