...
- 活用例: 機能要件書、非機能要件書、ユースケース図、業務プロセス設計書作成

### codebase

- 用途: 既存システムコードの分析、現行システム理解
- 活用例: 現行システムの機能棚卸し、データフロー分析

### search

- 用途: プロジェクト内のドキュメント検索、既存要件の調査
- 活用例: 関連ドキュメント検索、過去の要件定義書確認

### usages

- 用途: システム機能の使用箇所確認、影響範囲分析
- 活用例: 機能変更の影響範囲特定、データベーステーブルの参照関係調査

### openSimpleBrowser

- 用途: 競合サイト分析、業界動向調査、参考システムの確認
- 活用例: 競合他社UI/UX分析、業界ベストプラクティス調査

### fetch

- 用途: 業界レポート、競合情報、規制文書の取得
- 活用例: 市場調査レポート、法規制文書、ガイドライン取得

### duckduckgo

- 用途: 市場調査、競合分析、業界トレンド情報収集
- 活用例: 業界動向調査、競合他社のサービス分析、新技術・規制情報収集、ベストプラクティス事例検索
