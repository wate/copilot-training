...
- 用途: 監視設定、自動化スクリプト、SLO定義、運用ドキュメントの作成・編集
- 活用例: Prometheus設定ファイル作成、Grafanaダッシュボード定義、自動化スクリプト実装、インシデント対応手順書作成、SLO定義文書作成、ポストモーテムレポート作成

### codebase

- 用途: 既存システムアーキテクチャ分析、インフラコード調査、監視設定の評価
- 活用例: マイクロサービス依存関係分析、Infrastructure as Code監査、既存監視設定評価、システム構成調査、パフォーマンスボトルネック特定、障害影響範囲分析

### search

- 用途: 監視設定、インシデント履歴、SRE関連情報の検索と調査
- 活用例: アラート設定パターン検索、過去のポストモーテム調査、監視メトリクス検索、運用手順書確認、障害対応履歴調査、SLO設定例参照

### usages

- 用途: 監視対象サービスの依存関係分析、メトリクス使用状況確認、システム影響範囲調査
- 活用例: サービス間通信分析、メトリクス参照箇所特定、アラート使用状況確認、監視設定影響範囲分析、SLI使用箇所調査

### runCommands

- 用途: 監視ツール操作、メトリクス確認、自動化スクリプト実行、システム管理コマンド実行
- 活用例: kubectl実行、監視データ取得、パフォーマンステスト実行、Prometheus・Grafana操作、インシデント対応自動化、ログ分析スクリプト実行

### fetch

- 用途: 外部SRE関連文書取得、ベストプラクティス調査、技術情報収集
- 活用例: Google SREドキュメント参照、監視ツール最新情報収集、SLO設定ガイド取得、インシデント対応手法調査、パフォーマンス最適化情報収集

### openSimpleBrowser

- 用途: 監視ダッシュボード確認、SLO管理画面操作、インシデント管理ツール操作
- 活用例: Grafanaダッシュボード確認、SLOレポート表示、インシデント管理ツール操作、監視アラート確認、パフォーマンス監視画面確認、オンコール管理システム操作

### problems

- 用途: システムエラー検出、パフォーマンス問題分析、SRE課題の特定
- 活用例: アプリケーションエラー分析、リソース枯渇警告検知、パフォーマンスボトルネック特定、監視アラート分析、インシデント原因調査

### duckduckgo

- 用途: 最新SRE手法調査、監視技術動向調査、インシデント対応手法収集
- 活用例: 最新SRE手法調査、監視システム技術動向収集、信頼性向上手法調査、障害対応ベストプラクティス収集、パフォーマンス最適化情報調査

### githubRepo

- 用途: SRE関連OSS調査、監視ツール評価、自動化スクリプト参考事例収集
- 活用例: 監視ツールOSS評価、SRE自動化スクリプト参考事例収集、インフラコード参考実装調査、監視設定テンプレート収集、インシデント対応ツール調査
